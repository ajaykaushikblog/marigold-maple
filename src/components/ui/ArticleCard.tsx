...
/* Pinterest save affordance shown on hover over any card image. */
function SaveButton() {
  return (
    <button
      onClick={(e) => e.preventDefault()}
      aria-label="Save to Pinterest"
      className="absolute right-2.5 top-2.5 z-10 inline-flex items-center gap-1.5 rounded-full bg-[#e60023] px-3 py-1.5 text-[0.72rem] font-semibold text-white opacity-0 shadow-sm transition-all duration-200 hover:bg-[#c8001f] group-hover:opacity-100 group-focus-within:opacity-100"
    >
